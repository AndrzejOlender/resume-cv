...
\cvskill{Apache Kafka} {1+ rok} {0.4} \\[-2pt]
...
\iconhref{Globe}{12}{olender.io}{http://gitlab.olender.io}{black}\\[6pt]
...
\cvevent
	...
	{\cvlist{
		\item Usprawananie pipelinów CI/CD Gitlab
		...
		\item Pisanie manifestów Yaml/Kustomize 
